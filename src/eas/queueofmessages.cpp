...
QueueOfMessages::QueueOfMessages(const std::string& ip, uint16_t registerPort, uint16_t dataPort, const IoServicePtr &service)	{
...
int QueueOfMessages::fillValuesInCommandsHaveBeenDone(const std::vector<uint8_t> &data, int commandNumber)	{
