...
std::vector<std::string> Dispatcher::getMethodNames(bool includeHidden) const {
...
MethodWrapper& Dispatcher::addMethod(std::string name,
                                     MethodWrapper::Method method) {
    auto result = methods_.emplace(std::piecewise_construct,
