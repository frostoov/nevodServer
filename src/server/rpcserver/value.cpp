...
Value::Value(Array value) : type_(Type::ARRAY) {
    as_.array = new Array(std::move(value));
}

Value::Value(const DateTime& value) : type_(Type::DATE_TIME) {
    as_.dateTime = new DateTime(value);
    as_.dateTime->tm_isdst = -1;
}

Value::Value(int32_t value) : type_(Type::INTEGER_32) {
    as_.integer32 = value;
    as_.integer64 = value;
    as_.number = value;
}

Value::Value(int64_t value) : type_(Type::INTEGER_64) {
    as_.integer32 = value;
    as_.integer64 = value;
    as_.number = value;
...
Value::Value(Struct value) : type_(Type::STRUCT) {
...
Value::Value(const Value& other) : type_(other.type_), as_(other.as_) {
    switch (type_) {
        case Type::BOOLEAN:
        case Type::DOUBLE:
...
Value::Value(Value&& other) noexcept : type_(other.type_), as_(other.as_) {
